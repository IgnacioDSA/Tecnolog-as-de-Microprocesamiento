...
main_loop:
    ...
    ; Encender LEDs 1
    ldi r16, 0b11111111   ; Apagamos todos los LEDs
    ...
    ; Encender LEDs 2
    ldi r16, 0b11011011   ; Configuramos los pines de PORTD para encender ciertos LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    rcall delay           ; Llamamos a la subrutina delay
    ldi r16, 0xFF         ; Apagamos todos los LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    ...
    ; Encender LEDs 3
    ldi r16, 0x81         ; Configuramos los pines de PORTD para encender ciertos LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    rcall delay           ; Llamamos a la subrutina delay
    ldi r16, 0xFF         ; Apagamos todos los LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    ...
    ; Encender LEDs 4
    ldi r16, 0x24         ; Configuramos los pines de PORTD para encender ciertos LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    rcall delay           ; Llamamos a la subrutina delay
    ldi r16, 0xFF         ; Apagamos todos los LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    ...
    ; Encender LEDs 5
    ldi r16, 0x00         ; Configuramos todos los pines de PORTD para encender todos los LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    rcall delay           ; Llamamos a la subrutina delay
    ldi r16, 0xFF         ; Apagamos todos los LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    ...
    ; Encender LEDs 7
    ldi r16, 0xBD         ; Configuramos los pines de PORTD para encender ciertos LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    rcall delay           ; Llamamos a la subrutina delay
    ldi r16, 0xFF         ; Apagamos todos los LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    ...
    ; Encender LEDs 0
    ldi r16, 0xDB         ; Configuramos los pines de PORTD para encender ciertos LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
    rcall delay           ; Llamamos a la subrutina delay
    ldi r16, 0xFF         ; Apagamos todos los LEDs
    out PORTD, r16        ; Enviamos el valor a PORTD
